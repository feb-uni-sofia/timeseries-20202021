...
y_{t - 1} = 0.8 y_{t - 2} + u_{t-1}
$$

```{r}
xAr1.1 <- arima.sim(model = list(ar = c(0.8)), n = n)
```
...
$$
```{r}
xAr2.1 <- arima.sim(model = list(ar = c(0.8, -0.3)), n = 100000)
ARMAacf(ar = c(0.8, -0.3))
```

```{r}
plot(xAr2.1)
acf(xAr2.1, plot = FALSE)
